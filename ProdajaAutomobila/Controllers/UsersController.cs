...
namespace ProdajaAutomobila.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> DeleteAccount(string? id)
        {
            ...
            if (currentUser!.Id == appUser.Id)
            {
                TempData["ErrorMessage"] = "Ne mozete izbrisati svoj profil!";
                return RedirectToAction("Details", "Users", new { id });
            }
            ...
            TempData["ErrorMessage"] = "Trenutno nije moguće izbrisati profil: " + result.Errors.First().Description;
            return RedirectToAction("Details", "Users", new { id });
        }
    }
}
